...
ПРОВЕРКА ВЕРСИИ 2.0
-------------------
Реальный IS20-16A.im:
• 20 объектов/материальных секций;
• 20 661 вершина;
• 19 123 треугольника;
• 19 attachment points;
• повторная загрузка OBJ через независимый mesh loader прошла успешно.

Дополнительно проверены синтетические файлы:
• GEOM 100, 101, 102, 103, 104, 200, 201, 202-compatible;
• GEOM 104 с vertex colors и без них;
• GEOM 201 с tangents и без них;
• MATL 100, 101, 102, 103;
• wide strings;
• raw IDXM;
• line primitives;
• rigid parent bone;
• повреждённый дополнительный CHNK в salvage mode.
